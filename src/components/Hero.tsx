    ...
    <div className="min-h-screen flex items-center justify-center overflow-hidden">
      <div className="max-w-screen-xl w-full mx-auto grid lg:grid-cols-2 gap-12 px-6 py-12 lg:py-0">
        <div className="my-auto">
          <Badge className="bg-gradient-to-br via-100% from-primary via-muted/10 to-primary rounded-full py-1 border-none">
          ...
          <div className="mt-12 flex items-center gap-4">
            ...
            >
              <a
                href="https://www.youtube.com/watch?v=DupS46tLPn0"
                target="_blank"
